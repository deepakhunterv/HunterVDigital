...
final class HunterVD_Client_Training_Dashboard
{
    ...
    private const DEFAULT_SETTINGS = [
        'videos' => "How to Navigate and Edit Your New Website Easily | https://vimeo.com/1187170255\nHow to Use Markup for Website Changes | https://vimeo.com/1187170534?share=copy&fl=sv&fe=ci",
        ...
        'github_repo' => 'deepakhunterv/HunterVDigital',
                ...
                <table class="form-table" role="presentation">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('One video per line. Use either "Title | URL" or just a URL. Supports YouTube and Vimeo links.', 'huntervd-client-training-dashboard'); ?></p>
                        </td>
                    </tr>
    ...
    public function render_dashboard_widget(): void
    {
        ...
        if (! empty($rows)) {
            foreach ($rows as $row) {
                ...
                if (strpos($row, '|') !== false) {
                    [$maybe_title, $maybe_url] = array_map('trim', explode('|', $row, 2));
                    if (! empty($maybe_url)) {
                        $title = $maybe_title;
                        $url = $maybe_url;
                    }
                ...
                if (empty($title)) {
                    $title = wp_parse_url($url, PHP_URL_HOST) ?: __('Training Video', 'huntervd-client-training-dashboard');
                }
                ...
                if ($embed) {
                    ...
                    echo '<p><strong>' . esc_html($title) . ':</strong> <a href="' . esc_url($url) . '" target="_blank" rel="noopener noreferrer">' . esc_html($url) . '</a></p>';
                }
            }
        } else {
    ...
    public function enqueue_admin_assets(string $hook_suffix): void
    {
        ...
        wp_register_script('huntervd-editor-guard', false, [], '1.0.1', true);
